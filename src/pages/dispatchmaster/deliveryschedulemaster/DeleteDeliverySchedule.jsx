...
const DeleteDeliverySchedule = ({ open, onClose, schedule, onDelete }) => {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      const response = await axios.delete(`${BASE_URL}/api/delivery-schedules/${schedule._id}`, {
        headers: {
      ...
      if (response.data.success) {
        ...
        setError(response.data.message || 'Failed to delete delivery schedule');
      }
    } catch (err) {
      console.error('Error deleting delivery schedule:', err);
      setError(err.response?.data?.message || 'Failed to delete delivery schedule. Please try again.');
    } finally {
      setLoading(false);
    }
  };
