...
//                 disabled={!selectedEmployee || fetchingData}
//                 sx={{
//                   minWidth: 150,
//                   height: 56,
//                   background: HEADER_GRADIENT,
              ...
              <Grid container spacing={2} alignItems="center">
                ...
                >
                  <Button
                    ...
                    onClick={handleSubmit}
                    disabled={
                      !selectedEmployee || !selectedYear || fetchingData
                    }
                    sx={{
                      height: 56,
                      minWidth: 180,
                ...
                >
                  <Box>
                    ...
                    <Stack direction="row" spacing={2} sx={{ mt: 1 }}>
                      <Chip
                        label={
                          summaryData.employee.department?.DepartmentName ||
                          "No Dept"
                        }
                        size="small"
                      ...
                      <Chip
                        label={
                          summaryData.employee.designation?.DesignationName ||
                          "No Designation"
                        }
                        size="small"
                ...
                >
                  <Stack direction="row" alignItems="center" spacing={1}>
                    ...
                    <Typography variant="subtitle1" fontWeight={600}>
                      Overtime Details ({summaryData.overtime.yearlyTotal} hrs
                      total)
                    </Typography>
                  </Stack>
                    ...
                    {summaryData.overtime.monthlyBreakdown.length > 0 ? (
                      <TableContainer>
                        <Table size="small">
                          ...
                          <TableBody>
                            {summaryData.overtime.monthlyBreakdown.map(
                              (month) => (
              ...
              >
                ...
                >
                  <Stack direction="row" alignItems="center" spacing={1}>
                    ...
                    <Typography variant="subtitle1" fontWeight={600}>
                      Behavior Details (
                      {summaryData.behavior.overallStats.totalEntries} entries)
                    </Typography>
                  </Stack>
                  <IconButton size="small">
                      ...
                      <>
                        ...
                        <TableContainer sx={{ mb: 3 }}>
                          <Table size="small">
                            ...
                            <TableBody>
                              {summaryData.behavior.categoryWise.map(
                                (category) => (
