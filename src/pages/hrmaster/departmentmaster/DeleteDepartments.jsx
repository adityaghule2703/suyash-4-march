...
const DeleteDepartments = ({ open, onClose, department, onDelete }) => {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      const response = await axios.delete(`${BASE_URL}/api/departments/${department._id}`, {
        headers: {
      ...
      <DialogContent sx={{ pt: 3 }}>
        ...
        <div style={{ marginTop: '16px' }}>
          <Typography variant="body1" sx={{ mb: 2, fontSize: '0.875rem' }}>
            Are you sure you want to delete the department <strong>"{department?.DepartmentName}"</strong>?
          </Typography>
          <Typography variant="body2" color="textSecondary" sx={{ fontSize: '0.875rem' }}>
            This action cannot be undone. All users assigned to this department will be affected.
          </Typography>
