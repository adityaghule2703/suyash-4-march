  ...
  const handleUsersScroll = (event) => {
    ...
    if (listboxNode.scrollTop + listboxNode.clientHeight >= listboxNode.scrollHeight - 50) {
      if (usersPage < usersTotalPages && !usersLoading) {
        ...
        fetchUsers(usersSearch, usersPage + 1);
      }
    }
  };
          ...
          <Stack spacing={2} sx={{ mt: 1 }}>
            <Stack direction="row" spacing={1.5}>
              ...
              <Autocomplete
                ...
                renderOption={(props, option) => {
                  const name = option.EmployeeID?.FirstName && option.EmployeeID?.LastName
                ...
                ListboxProps={{ onScroll: handleUsersScroll, style: { maxHeight: 200 } }}
              />
            </Stack>
            <TextField
              fullWidth
