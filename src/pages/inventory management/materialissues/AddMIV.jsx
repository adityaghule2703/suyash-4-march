...
// // //   Tooltip
// // // } from "@mui/material";
// // // import { Add, Delete, Close, Warning as WarningIcon, Error as ErrorIcon, Search as SearchIcon } from "@mui/icons-material";
...
// // //   // Get available batch numbers for an item from GRNs
...
// // //         // Clear batch/heat when item changes
// // //         updated[index].batch_no = '';
// // //         updated[index].heat_no = '';
// // //       }
// // //     }

// // //     // Auto-populate heat_no when batch_no is selected
...
// // //         // Optionally auto-populate bin_id from storage_location
...
// // //   const validateForm = () => {
// // //     const newErrors = {};
// // //     if (!formData.wo_id) newErrors.wo_id = 'Work Order is required';
...
// // //   const getWorkOrderDisplay = (wo) => {
// // //     if (!wo) return '';
// // //     return wo.wo_number || wo.work_order_number || wo._id || '';
// // //   };
...
// // //         <Stack spacing={2.5}>
// // //           {errors.submit && (
// // //             <Alert severity="error" sx={{ borderRadius: 1.5 }} onClose={() => setErrors(prev => ({ ...prev, submit: '' }))}>
// // //               {errors.submit}
// // //             </Alert>
// // //           )}

// // //           {workOrderError && (
// // //             <Alert severity="warning" icon={<WarningIcon />} sx={{ borderRadius: 1.5 }} onClose={() => setWorkOrderError('')}>
// // //               {workOrderError}
// // //             </Alert>
// // //           )}

// // //           {stockError && (
// // //             <Alert severity="error" icon={<ErrorIcon />} sx={{ borderRadius: 1.5 }} onClose={() => setStockError('')}>
// // //               <strong>Stock Insufficient!</strong><br />
// // //               {stockError}<br />
// // //               <Typography sx={{ fontSize: '0.65rem', mt: 1 }}>
// // //                 The system uses FIFO batch selection. Please reduce the quantity or select a different item/warehouse.
// // //               </Typography>
// // //             </Alert>
// // //           )}
...
// // //                   fullWidth
// // //                   options={workOrders}
// // //                   getOptionLabel={(opt) => getWorkOrderDisplay(opt)}
...
// // //                     <TableCell sx={{ fontSize: '0.7rem', fontWeight: 600, minWidth: 200, py: 1.5 }}>Item / Material</TableCell>
// // //                     <TableCell sx={{ fontSize: '0.7rem', fontWeight: 600, minWidth: 100, py: 1.5 }}>Part No</TableCell>
// // //                     <TableCell sx={{ fontSize: '0.7rem', fontWeight: 600, minWidth: 200, py: 1.5 }}>Description</TableCell>
// // //                     <TableCell sx={{ fontSize: '0.7rem', fontWeight: 600, minWidth: 100, py: 1.5 }}>Quantity*</TableCell>
// // //                     <TableCell sx={{ fontSize: '0.7rem', fontWeight: 600, minWidth: 100, py: 1.5 }}>Unit*</TableCell>
// // //                     <TableCell sx={{ fontSize: '0.7rem', fontWeight: 600, minWidth: 150, py: 1.5 }}>Warehouse*</TableCell>
// // //                     <TableCell sx={{ fontSize: '0.7rem', fontWeight: 600, minWidth: 150, py: 1.5 }}>Bin</TableCell>
// // //                     <TableCell sx={{ fontSize: '0.7rem', fontWeight: 600, minWidth: 120, py: 1.5 }}>Batch No</TableCell>
// // //                     <TableCell sx={{ fontSize: '0.7rem', fontWeight: 600, minWidth: 120, py: 1.5 }}>Heat No</TableCell>
// // //                     <TableCell sx={{ fontSize: '0.7rem', fontWeight: 600, minWidth: 100, py: 1.5 }}>Unit Cost</TableCell>
// // //                     <TableCell sx={{ width: 50, py: 1.5 }}></TableCell>
// // //                   </TableRow>
// // //                 </TableHead>
// // //                 <TableBody>
...
// // //                             fullWidth
// // //                             options={items}
// // //                             getOptionLabel={(opt) => getItemDisplay(opt)}
...
// // //                               <MenuItem key={unit} value={unit} sx={{ fontSize: '0.75rem' }}>
// // //                                 {unit}
// // //                               </MenuItem>
// // //                             ))}
// // //                           </TextField>
...
// // //                             fullWidth
// // //                             options={warehouses}
// // //                             getOptionLabel={(opt) => getWarehouseDisplay(opt)}
...
// // //                             getOptionLabel={(opt) => getBinDisplay(opt)}
...
// // //                             getOptionLabel={(opt) => `${opt.batch_no} (Available: ${opt.available_qty} ${item.unit})`}
...
// // //           disabled={loading || !!workOrderError}
// // //           startIcon={!loading && <Add sx={{ fontSize: "1rem" }} />}
// // //           sx={{
// // //             height: 32,
// // //             px: 2,
// // //             borderRadius: 1.5,
...
// // //           }}
// // //         >
// // //           {loading ? <CircularProgress size={16} sx={{ color: COLORS.text.light }} /> : "Create MIV (Draft)"}
// // //         </Button>
// // //       </DialogActions>
// // //     </Dialog>
// // //   );
...
//   const [userTypeForAdd, setUserTypeForAdd] = useState(''); // 'received_by' or 'authorised_by'
...
//     if (userTypeForAdd === 'received_by') {
//       setFormData(prev => ({ ...prev, received_by: newUser._id }));
//     } else if (userTypeForAdd === 'authorised_by') {
...
//                 {/* Received By (User) with Add button */}
//                 <Grid size={{ xs: 12, md: 4 }}>
//                   <Box sx={{ display: 'flex', flexDirection: 'column', gap: 0.5 }}>
//                     <Typography sx={labelStyle}>
//                       RECEIVED BY <span style={{ color: '#EF4444' }}>*</span>
