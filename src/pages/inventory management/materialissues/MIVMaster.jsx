...
// //   // Only Draft status can be edited, posted, or cancelled
// //   const isDraft = item.status === MIV_STATUS.DRAFT;
// //   // Issued status can be printed and viewed
...
// //       {/* Status Filter Tabs - Updated to match backend statuses */}
// //       <Paper sx={{ 
// //         mb: 2.5, 
// //         borderRadius: 2, 
// //         border: `1px solid ${COLORS.border}`, 
...
// //                           {formatDate(item.miv_date || item.createdAt)}
// //                         </Typography>
// //                       </TableCell>
// //                       <TableCell>
