...
//       Expired: { color: '#475569', bg: '#F1F5F9' }
//     };
...
//                   <Typography sx={valueStyle}>
//                     {displayData.wo_id?.planned_qty || 0}
//                   </Typography>
//                 </Grid>
//               </Grid>
//             </Box>
...
//                     <PersonIcon sx={{ fontSize: '0.875rem', color: COLORS.text.tertiary }} />
//                     <Typography sx={valueStyle}>
//                       {getPersonName(displayData.posted_by) || 'Not Posted'}
//                     </Typography>
//                   </Stack>
//                 </Grid>
//               </Grid>
...
//             {/* FIFO Batch Details (if available in items) */}
//             {displayData.items?.some(item => item._fifoBatches && item._fifoBatches.length > 0) && (
//               <Box>
//                 <Typography sx={{ fontSize: '0.7rem', fontWeight: 600, color: COLORS.primary, mb: 2, letterSpacing: '0.5px' }}>
//                   FIFO BATCH DETAILS
//                 </Typography>
...
//                     <TableBody>
//                       {displayData.items.map((item, idx) => (
//                         item._fifoBatches && item._fifoBatches.map((batch, batchIdx) => (
//                           <TableRow key={`${idx}-${batchIdx}`}>
//                             <TableCell sx={{ fontSize: '0.7rem' }}>{item.part_no || '-'}</TableCell>
//                             <TableCell sx={{ fontSize: '0.7rem' }}>{batch.batch_no || '-'}</TableCell>
//                             <TableCell sx={{ fontSize: '0.7rem' }} align="right">{batch.quantity || 0}</TableCell>
//                             <TableCell sx={{ fontSize: '0.7rem' }} align="right">{formatCurrency(batch.unit_cost || 0)}</TableCell>
//                             <TableCell sx={{ fontSize: '0.7rem' }} align="right">{formatCurrency(batch.total_value || 0)}</TableCell>
//                             <TableCell sx={{ fontSize: '0.7rem' }}>{batch.bin_id || '-'}</TableCell>
//                           </TableRow>
//                         ))
//                       ))}
//                     </TableBody>
