...
const ViewVendor = ({ open, onClose, vendor, onEdit }) => {
  ...
  // ✅ UPDATED: Enhanced AVL items render function with detailed view
  const renderAvlItems = () => {
    if (!vendor.avl_items || vendor.avl_items.length === 0) {
      return (
    ...
    return (
      <Stack spacing={1.5}>
        {vendor.avl_items.map((item, index) => {
          // Handle both populated object and just ID
          ...
          const itemId = isPopulated ? item._id : item;
                ...
                <Stack spacing={1}>
                  ...
                  <Stack direction="row" justifyContent="space-between" alignItems="flex-start">
                    <Stack direction="row" spacing={1} alignItems="center">
                      <Inventory sx={{ color: PRIMARY_BLUE, fontSize: 18 }} />
                      <Typography variant="subtitle2" fontWeight={700} color={PRIMARY_DARK}>
                        {itemName}
                      </Typography>
                    </Stack>
                  ...
                  {isPopulated && itemDescription && (
                    <Stack direction="row" spacing={1} alignItems="flex-start">
                      <Description sx={{ color: '#94A3B8', fontSize: 14, mt: 0.2 }} />
                      <Typography variant="body2" color="#475569" fontSize="12px">
                        {itemDescription}
                      </Typography>
                    </Stack>
                  )}
                  ...
                  {/* Additional Details */}
                  {(isPopulated && (itemHsn || itemId)) && (
                    <Stack direction="row" spacing={2} flexWrap="wrap" useFlexGap>
                      {isPopulated && itemHsn && (
                        <Stack direction="row" spacing={0.5} alignItems="center">
                          <Receipt sx={{ color: '#94A3B8', fontSize: 12 }} />
                      ...
                      {itemId && (
                        <Stack direction="row" spacing={0.5} alignItems="center">
                          <BadgeIcon sx={{ color: '#94A3B8', fontSize: 12 }} />
                          <Typography variant="caption" color="#64748B" fontSize="10px">
                            ID: {typeof itemId === 'string' ? itemId.slice(-6) : itemId}
                          </Typography>
                        </Stack>
                      )}
                    </Stack>
      ...
      case 2: // Tax & Bank
        return (
          <Stack spacing={1.5} sx={{ pb: 1 }}>
            ...
            {/* ✅ UPDATED AVL Details with Enhanced Display */}
            {(vendor.avl_approved || (vendor.avl_items && vendor.avl_items.length > 0)) && (
              <Paper sx={{ p: 2, backgroundColor: '#FFFFFF', borderRadius: 1.5, border: '1px solid #E3E8EF' }}>
                <Stack direction="row" justifyContent="space-between" alignItems="center" sx={{ mb: 1.5 }}>
                  <Typography variant="subtitle2" sx={{ color: PRIMARY_DARK, fontWeight: 600, fontSize: '0.8rem' }}>
                    <VerifiedUserIcon sx={{ fontSize: 16, mr: 0.5, verticalAlign: 'middle' }} /> 
                    AVL Approval Details
                  </Typography>
                  {vendor.avl_approved && (
                ...
                <Grid container spacing={1.5}>
                  ...
                  <Grid size={{ xs: 12 }}>
                    <Stack direction="row" spacing={1} alignItems="flex-start">
                      <Inventory sx={{ color: PRIMARY_BLUE, fontSize: 16, mt: 0.3 }} />
                      <Box sx={{ flex: 1 }}>
                        <Typography 
                          variant="caption" 
                          sx={{ 
