...
const ActionMenu = ({ customer, onView, onEdit, onDelete, anchorEl, onClose, onOpen }) => {
  return (
    <>
...
const CustomerMaster = () => {
  ...
  const handleSearch = (event) => {
    ...
    const filtered = customers.filter(customer =>
      ...
      (customer.ContactPerson && customer.ContactPerson.toLowerCase().includes(value)) ||
  ...
  const handleSelectAll = (event) => {
    if (event.target.checked) {
      setSelected(filteredCustomers.map(customer => customer._id));
    } else {
      setSelected([]);
    }
  };
    ...
    <Box sx={{ p: 3 }}>
      ...
      <Box sx={{ mb: 3 }}>
        ...
        <Typography variant="body2" color="#64748B" sx={{ mt: 0.5 }}>
          Manage and organize customer information and details
        </Typography>
      </Box>
              ...
              {loading ? (
                ...
                paginatedCustomers.map((customer, index) => {
                  ...
                  const isActionMenuOpen = Boolean(actionMenuAnchor) && 
                    selectedCustomerForAction?._id === customer._id;
                    ...
                    >
                      ...
                      <TableCell>
                        ...
                        <Typography variant="caption" color="#64748B">
                          {customer.State || 'State not specified'}
                        </Typography>
                      </TableCell>
                      <TableCell>
                      ...
                      <TableCell>
                        {getStatusChip(customer.IsActive)}
                      </TableCell>
