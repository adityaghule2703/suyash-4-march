...
const Header = () => {
  ...
  const quotationMasterItems = [
    ...
    // { name: 'Process Details Master', path: '/master/processdetailsmaster', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2', moduleKey: MODULES.PROCESS_DETAILS_MASTER, page: PAGES.PROCESS_DETAILS_MASTER },
    ...
    // { name: 'Costing Master', path: '/master/costingmaster', icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z', moduleKey: MODULES.COSTING_MASTER, page: PAGES.COSTING_MASTER },
    // { name: 'Company Financial Master', path: '/master/companyfinancialmaster', icon: 'M3 10h18M6 14h1m4 0h1m-6 4h12a2 2 0 002-2V8a2 2 0 00-2-2H6a2 2 0 00-2 2v8a2 2 0 002 2z', moduleKey: MODULES.COMPANY_FINANCIAL_MASTER, page: PAGES.COMPANY_FINANCIAL_MASTER },
