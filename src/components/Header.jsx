...
//     { name: 'Organization / Company', path: '/master/companymaster', icon: 'M3.75 21h16.5M3.75 3h16.5M3.75 7.5h16.5M3.75 12h16.5M3.75 16.5h7.5' },
//     { name: 'Supplier', path: '/master/vendormaster', icon: 'M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z' },
//     { name: 'Tax Configuration / Tax Rule', path: '/master/taxmaster', icon: 'M12 6v12m-3-2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.879-1.106-2.303 0-3.182s2.9-.879 4.006 0l.415.33M21 12a9 9 0 11-18 0 9 9 0 0118 0z' },
...
//     { name: 'Product / Item Catalog', path: '/master/itemmaster', icon: 'M3.75 12h16.5m-16.5 3.75h16.5M3.75 19.5h16.5M5.625 4.5h12.75a1.875 1.875 0 010 3.75H5.625a1.875 1.875 0 010-3.75z' },
//     { name: 'Manufacturing Process', path: '/master/processmaster', icon: 'M3 4.5h14.25M3 9h9.75M3 13.5h9.75m4.5-4.5v12m0 0l-3.75-3.75M17.25 21L21 17.25' },
...
//     { name: 'Employee Registry', path: '/hrmaster/employeemaster', icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z' },
//     { name: 'Leave Policies', path: '/hrmaster/leavetypemaster', icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z' },
//     { name: 'Accident Reporting', path: '/hrmaster/accidentmaster', icon: 'M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z' },
//     { name: 'Hiring Requests', path: '/hrmaster/requisitionmaster', icon: 'M15 5v2m-6 0V5m6 0a2 2 0 012 2m-8-2a2 2 0 00-2 2m0 0v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2m-6 7h6m-6 4h6m-6-8h6' },
//     { name: 'Career Opportunities', path: '/hrmaster/jobopeningmaster', icon: 'M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z' },
//     { name: 'Candidate Master', path: '/hrmaster/candidatemaster', icon: 'M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z' },
//     { name: 'Interview Scheduling', path: '/hrmaster/interviewmaster', icon: 'M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z' },
//     { name: 'Selected Candidate', path: '/hrmaster/selectedcandidatesmaster', icon: 'M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z' },
//     { name: 'Salary Master', path: '/hrmaster/salarymaster', icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z' },
//     { name: 'Piece Rate Master', path: '/hrmaster/pieceratemaster', icon: 'M12 8v13m0-13V6a2 2 0 112 2h-2zm0 0V5.5A2.5 2.5 0 109.5 8H12zm-7 4h14M5 12a2 2 0 110-4h14a2 2 0 110 4M5 12v7a2 2 0 002 2h10a2 2 0 002-2v-7' },
//     { name: 'Attendance Regularization', path: '/hrmaster/regularizationmaster', icon: 'M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15' },
//     { name: 'Employee Leave Records', path: '/hrmaster/employeeleavemaster', icon: 'M16 4v1h4v16H4V5h4V4a2 2 0 014 0M8 8h8M8 12h6m-6 4h4' },
//     { name: 'Leave Administration', path: '/hrmaster/adminleavemaster', icon: 'M5.121 17.804A13.937 13.937 0 0112 16c2.5 0 4.847.655 6.879 1.804M15 10a3 3 0 11-6 0 3 3 0 016 0zm6 2a9 9 0 11-18 0 9 9 0 0118 0z M8 14h8' },
...
//     ...(role === "HR" || role === "Admin"
//       ? [{ name: 'Leave Approval', path: '/leave/approval', icon: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z' }]
//       : [])
//   ];
...
//   useEffect(() => {
//     setFilteredQuotationItems(quotationMasterItems);
//     setFilteredHRItems(allHRItems);
//   }, []);
...
//                               ref={masterSearchRef}
//                               type="text"
//                               placeholder={`Search ${activeSubmenu === 'quotation' ? 'Quotation' : 'HR'}...`}
...
//                             {activeSubmenu === 'quotation' ? 'Quotation' : 'HR'}
//                           </h3>
//                           <span className="text-[11px] text-[#94A3B8]">
//                             {activeSubmenu === 'quotation' ? filteredQuotationItems.length : filteredHRItems.length}
//                           </span>
//                         </div>
...
//                           <p className="text-xs text-[#4B5568]">Unable to load user</p>
//                           <button
//                             onClick={fetchUserProfile}
//                             className="mt-1 text-[10px] text-[#0A5C60] hover:text-[#063B3E] font-medium"
//                           >
//                             Retry
//                           </button>
//                         </div>
...
const Header = () => {
  ...
  const quotationMasterItems = [
    ...
    { name: 'Leads', path: '/master/leadsmaster', icon: 'M5.121 17.804A13.937 13.937 0 0112 16c2.5 0 4.847.655 6.879 1.804M15 10a3 3 0 11-6 0 3 3 0 016 0zm6 2a9 9 0 11-18 0 9 9 0 0118 0z M8 14h8', moduleKey: MODULES.QUOTATION_MASTER, page: PAGES.QUOTATION },
  ...
  const filterItemsByPermissions = () => {
    ...
    masterCategories[1].count = accessibleHRItems.length;
  };
          ...
          <div className="flex items-center justify-between h-14">
            ...
            <div className="flex items-center space-x-3 relative z-10">
              ...
              <div className="desktop-nav flex items-center space-x-0.5 ml-1">
                ...
                {/* Master Dropdown */}
                {(filteredQuotationItems.length > 0 || filteredHRItems.length > 0) && (
                  <div className="relative" ref={masterRef}>
                    <button
                      onClick={() => toggleDropdown('master')}
                      className={`flex items-center px-3 py-1.5 text-xs font-medium rounded-md transition-all whitespace-nowrap ${
