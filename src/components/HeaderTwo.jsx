...
const HeaderTwo = () => {
  ...
  const quotationMasterItems = [
    { name: 'Customer Master', path: '/master/customermaster', icon: 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5 2.1a9 9 0 10-18 0' },
        ...
        <div className="px-4 sm:px-6 lg:px-8">
          <div className="flex">
            ...
            <NavLink
              to="/dashboard"
              className={({ isActive }) => 
                `flex items-center px-6 py-4 text-sm font-medium transition-all whitespace-nowrap ${
                  isActive
            ...
            <div className="relative" ref={masterRef}>
              ...
              <div 
                ref={dropdownRef}
                className={`absolute left-0 top-full mt-0 bg-white rounded-lg shadow-2xl border border-slate-200 py-2 z-[100] transition-all duration-200 flex ${
              ...
              >
                ...
                <div className="w-48 border-r border-slate-100">
                  {masterCategories.map((category) => (
                    <div
                      key={category.type}
                      className={`relative px-4 py-3 cursor-pointer transition-all group ${
                    ...
                    >
                      ...
                      <svg className={`absolute right-3 top-1/2 transform -translate-y-1/2 w-4 h-4 transition-transform ${
                        activeSubmenu === category.type ? 'rotate-90 text-blue-500' : 'text-slate-400'
                ...
                {activeSubmenu && (
                  ...
                  >
                    ...
                    <div className={`${activeSubmenu === 'quotation' ? 'block' : 'hidden'}`}>
                      ...
                      {quotationMasterItems.map((item) => (
                        <NavLink
                          ...
                          className={`flex items-center px-4 py-3 text-sm transition-all hover:bg-slate-50 ${
                            currentPath === item.path ? 'text-blue-600 bg-blue-50' : 'text-slate-700'
                          }`}
                        >
                    ...
                    <div className={`${activeSubmenu === 'hr' ? 'block' : 'hidden'}`}>
                      <div className="px-4 py-3 bg-slate-50 border-b border-slate-100">
                        <h3 className="text-xs font-semibold text-slate-500 uppercase tracking-wider">HR Masters</h3>
                      </div>
